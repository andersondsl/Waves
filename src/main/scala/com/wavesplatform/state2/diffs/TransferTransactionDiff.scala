...
object TransferTransactionOLDDiff {
  def apply(state: SnapshotStateReader, s: FunctionalitySettings, blockTime: Long, height: Int)(tx: TransferTransactionOLD): Either[ValidationError, Diff] = {
